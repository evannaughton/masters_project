...
```{r}
# Filtering out patients from clinical data
quartile_data2_filtered <- quartile_data2 %>%
  filter(!(Sample.ID %in% ids_to_exclude))

selected_data2 <- quartile_data2_filtered %>%
  select(1, 4, 5, 60, 61, 62, 63)

write.csv(selected_data2, "/home/evannaughton/project/transcriptomic_analysis_cna_quartiles/selected_quartile_data2.csv")
```
...
**DE Proteins in each subgroup based on RPPA data**
